...
moyu.set_anim("bored",   {44, 45, 46, 47},   2)
moyu.set_anim("sneak",   {48, 49, 50, 51},   5)
moyu.set_anim("scared",  {52, 53, 54, 55},   7)
moyu.set_anim("playful", {56, 57, 58, 59},   7)
moyu.set_anim("peek",    {60, 61, 62, 63},   3)
moyu.set_anim("dodge",   {64, 65, 66, 67},   9)
moyu.set_anim("stretch", {68, 69, 70, 71},   3)
moyu.set_anim("yawn",    {72, 73, 74, 75},   2)
