...
void platform_window_set_pixels(platform_window* w, const uint32_t* rgba, int w_, int h_);
...
char* platform_read_file(const char* path, size_t* out_len);  // returns NULL on failure
